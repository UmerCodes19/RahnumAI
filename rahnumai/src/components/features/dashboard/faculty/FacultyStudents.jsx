 ...
 return (
  <div className={`min-h-screen space-y-6 p-6 ${darkMode ? '' : ''}`}>
    <div className="flex items-center justify-between">
      <div>
        <h1 className={`text-3xl font-bold mb-2 ${darkMode ? '' : ''}`}>Students</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent ${
              darkMode 
        ...
        <select className={`px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 ${
          darkMode 
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {students.map((student) => (
        <div
          key={student.id}
          className={`rounded-xl p-6 transition-all duration-300 group border ${
            darkMode 
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1">
              ...
              <p className={`text-sm ${darkMode ? 'text-slate-400' : 'text-slate-600'}`}>{student.course}</p>
          ...
          <div className={`flex items-center justify-between pt-4 border-t ${darkMode ? 'border-slate-700' : 'border-slate-200'}`}>
